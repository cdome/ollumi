...
import {ReadingClockChartComponent} from './reading-clock-chart.component';
...
describe('ReadingClockChartComponent', () => {
  let fixture: ComponentFixture<ReadingClockChartComponent>;
  let component: ReadingClockChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [ReadingClockChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(ReadingClockChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(ReadingClockChartComponent);
