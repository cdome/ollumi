...
import {CompletionTimelineChartComponent} from './completion-timeline-chart.component';
...
describe('CompletionTimelineChartComponent', () => {
  let fixture: ComponentFixture<CompletionTimelineChartComponent>;
  let component: CompletionTimelineChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CompletionTimelineChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(CompletionTimelineChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(CompletionTimelineChartComponent);
