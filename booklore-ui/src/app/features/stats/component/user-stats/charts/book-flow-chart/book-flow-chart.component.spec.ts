...
describe('BookFlowChartComponent', () => {
  let fixture: ComponentFixture<BookFlowChartComponent>;
  let component: BookFlowChartComponent;
  ...
  beforeEach(() => {
    bookServiceMock = {
      bookState$: new BehaviorSubject({loaded: true, books: [], error: null}),
    ...
    TestBed.configureTestingModule({
      imports: [BookFlowChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(BookFlowChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(BookFlowChartComponent);
  ...
  it('should have no data with empty books', () => {
