...
describe('GenreStatsChartComponent', () => {
  let fixture: ComponentFixture<GenreStatsChartComponent>;
  let component: GenreStatsChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [GenreStatsChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(GenreStatsChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(GenreStatsChartComponent);
