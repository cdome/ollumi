...
describe('PeakHoursChartComponent', () => {
  ...
  let component: PeakHoursChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [PeakHoursChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(PeakHoursChartComponent, {
      set: {
