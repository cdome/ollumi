...
describe('PublicationEraChartComponent', () => {
  let fixture: ComponentFixture<PublicationEraChartComponent>;
  let component: PublicationEraChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [PublicationEraChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(PublicationEraChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(PublicationEraChartComponent);
