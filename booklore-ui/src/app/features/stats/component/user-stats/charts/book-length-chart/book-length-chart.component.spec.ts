...
describe('BookLengthChartComponent', () => {
  let fixture: ComponentFixture<BookLengthChartComponent>;
  let component: BookLengthChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [BookLengthChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(BookLengthChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(BookLengthChartComponent);
