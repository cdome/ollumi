...
describe('ReadingProgressChartComponent', () => {
  let fixture: ComponentFixture<ReadingProgressChartComponent>;
  let component: ReadingProgressChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [ReadingProgressChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(ReadingProgressChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(ReadingProgressChartComponent);
