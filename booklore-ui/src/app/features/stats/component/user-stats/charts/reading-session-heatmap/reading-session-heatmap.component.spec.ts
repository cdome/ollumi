...
describe('ReadingSessionHeatmapComponent', () => {
  ...
  let component: ReadingSessionHeatmapComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [ReadingSessionHeatmapComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(ReadingSessionHeatmapComponent, {
      set: {
