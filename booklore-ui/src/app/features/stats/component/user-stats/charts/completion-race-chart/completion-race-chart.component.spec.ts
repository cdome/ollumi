...
import {CompletionRaceChartComponent} from './completion-race-chart.component';
...
describe('CompletionRaceChartComponent', () => {
  let fixture: ComponentFixture<CompletionRaceChartComponent>;
  let component: CompletionRaceChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CompletionRaceChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(CompletionRaceChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(CompletionRaceChartComponent);
