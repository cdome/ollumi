...
describe('SeriesProgressChartComponent', () => {
  let fixture: ComponentFixture<SeriesProgressChartComponent>;
  let component: SeriesProgressChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [SeriesProgressChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(SeriesProgressChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(SeriesProgressChartComponent);
