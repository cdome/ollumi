...
describe('RatingTasteChartComponent', () => {
  let fixture: ComponentFixture<RatingTasteChartComponent>;
  let component: RatingTasteChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [RatingTasteChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(RatingTasteChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(RatingTasteChartComponent);
