...
describe('ReadingSurvivalChartComponent', () => {
  let fixture: ComponentFixture<ReadingSurvivalChartComponent>;
  let component: ReadingSurvivalChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [ReadingSurvivalChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(ReadingSurvivalChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(ReadingSurvivalChartComponent);
