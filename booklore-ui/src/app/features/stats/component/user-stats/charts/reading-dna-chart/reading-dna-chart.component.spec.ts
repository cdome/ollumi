...
describe('ReadingDNAChartComponent', () => {
  let fixture: ComponentFixture<ReadingDNAChartComponent>;
  let component: ReadingDNAChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [ReadingDNAChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(ReadingDNAChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(ReadingDNAChartComponent);
