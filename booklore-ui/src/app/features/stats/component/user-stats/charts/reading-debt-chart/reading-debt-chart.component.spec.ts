...
describe('ReadingDebtChartComponent', () => {
  let fixture: ComponentFixture<ReadingDebtChartComponent>;
  let component: ReadingDebtChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [ReadingDebtChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(ReadingDebtChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(ReadingDebtChartComponent);
