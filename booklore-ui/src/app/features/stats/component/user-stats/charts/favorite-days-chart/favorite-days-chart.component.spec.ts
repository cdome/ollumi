...
describe('FavoriteDaysChartComponent', () => {
  let fixture: ComponentFixture<FavoriteDaysChartComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [FavoriteDaysChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(FavoriteDaysChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(FavoriteDaysChartComponent);
