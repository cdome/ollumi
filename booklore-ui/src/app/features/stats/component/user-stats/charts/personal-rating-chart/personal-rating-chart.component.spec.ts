...
describe('PersonalRatingChartComponent', () => {
  let fixture: ComponentFixture<PersonalRatingChartComponent>;
  let component: PersonalRatingChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [PersonalRatingChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(PersonalRatingChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(PersonalRatingChartComponent);
