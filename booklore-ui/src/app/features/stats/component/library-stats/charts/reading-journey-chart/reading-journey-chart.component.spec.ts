...
describe('ReadingJourneyChartComponent', () => {
  let fixture: ComponentFixture<ReadingJourneyChartComponent>;
  let component: ReadingJourneyChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [ReadingJourneyChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(ReadingJourneyChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(ReadingJourneyChartComponent);
