...
describe('MetadataScoreChartComponent', () => {
  let fixture: ComponentFixture<MetadataScoreChartComponent>;
  let component: MetadataScoreChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [MetadataScoreChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(MetadataScoreChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(MetadataScoreChartComponent);
