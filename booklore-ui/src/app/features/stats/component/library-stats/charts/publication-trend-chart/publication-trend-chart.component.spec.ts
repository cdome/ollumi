...
describe('PublicationTrendChartComponent', () => {
  let fixture: ComponentFixture<PublicationTrendChartComponent>;
  let component: PublicationTrendChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [PublicationTrendChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(PublicationTrendChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(PublicationTrendChartComponent);
