...
describe('TopItemsChartComponent', () => {
  let fixture: ComponentFixture<TopItemsChartComponent>;
  let component: TopItemsChartComponent;
  ...
  beforeEach(() => {
    const mockBooks = [
      createMockBook({id: 1, metadata: {categories: ['Fiction']} as any}),
      createMockBook({id: 2, metadata: {categories: ['Science']} as any}),
      createMockBook({id: 3, metadata: {categories: ['Fiction']} as any})
    ];
    ...
    TestBed.configureTestingModule({
      imports: [TopItemsChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(TopItemsChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(TopItemsChartComponent);
