...
describe('PageCountChartComponent', () => {
  let fixture: ComponentFixture<PageCountChartComponent>;
  let component: PageCountChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [PageCountChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(PageCountChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(PageCountChartComponent);
