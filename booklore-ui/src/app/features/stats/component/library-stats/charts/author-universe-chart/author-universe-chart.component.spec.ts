...
describe('AuthorUniverseChartComponent', () => {
  let fixture: ComponentFixture<AuthorUniverseChartComponent>;
  let component: AuthorUniverseChartComponent;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [AuthorUniverseChartComponent, TranslocoTestingModule.forRoot({langs: {}})],
      providers: [
    ...
    TestBed.overrideComponent(AuthorUniverseChartComponent, {
      set: {
        imports: [CommonModule, TranslocoTestingModule]
      }
    });

    fixture = TestBed.createComponent(AuthorUniverseChartComponent);
