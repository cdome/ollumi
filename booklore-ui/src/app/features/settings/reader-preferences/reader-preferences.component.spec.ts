...
describe('ReaderPreferences', () => {
  let fixture: ComponentFixture<ReaderPreferences>;
  let component: ReaderPreferences;
  ...
  beforeEach(() => {
    ...
    }).overrideComponent(ReaderPreferences, {
      set: {
    ...
    fixture = TestBed.createComponent(ReaderPreferences);
