...
const mockMagicShelfService = {
  shelvesState$: new BehaviorSubject({shelves: [], loaded: true, error: null}).asObservable()
};
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {provide: MagicShelfService, useValue: mockMagicShelfService}
      ]
    }).overrideComponent(ViewPreferencesComponent, {
      set: {
