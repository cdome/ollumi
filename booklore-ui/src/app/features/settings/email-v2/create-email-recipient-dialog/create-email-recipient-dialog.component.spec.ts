...
describe('CreateEmailRecipientDialogComponent', () => {
  let fixture: ComponentFixture<CreateEmailRecipientDialogComponent>;
  let component: CreateEmailRecipientDialogComponent;
  ...
  beforeEach(() => {
    ...
    }).overrideComponent(CreateEmailRecipientDialogComponent, {
      set: {
    ...
    fixture = TestBed.createComponent(CreateEmailRecipientDialogComponent);
