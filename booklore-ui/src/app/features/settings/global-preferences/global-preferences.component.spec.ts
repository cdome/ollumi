...
describe('GlobalPreferencesComponent', () => {
  let fixture: ComponentFixture<GlobalPreferencesComponent>;
  let component: GlobalPreferencesComponent;
  ...
  beforeEach(() => {
    ...
    }).overrideComponent(GlobalPreferencesComponent, {
      set: {
    ...
    fixture = TestBed.createComponent(GlobalPreferencesComponent);
