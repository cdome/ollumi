...
import {CustomFontsComponent} from './custom-fonts.component';
...
describe('CustomFontsComponent', () => {
  let fixture: ComponentFixture<CustomFontsComponent>;
  let component: CustomFontsComponent;
  ...
  beforeEach(() => {
    ...
    }).overrideComponent(CustomFontsComponent, {
      set: {
    ...
    fixture = TestBed.createComponent(CustomFontsComponent);
